...
import com.example.faby.smack.Utilities.URL_GET_CHANNELS
import com.example.faby.smack.Utilities.URL_GET_MESSAGES
...
object MessageService {
    ...
    fun getChannels(complete: (Boolean) -> Unit){
        ...
        val channelsRequest = object: JsonArrayRequest(Method.GET, URL_GET_CHANNELS, null, Response.Listener { response ->
            ...
            Log.d("ERROR", "Could not retrieve channelsl")
            complete(false)
